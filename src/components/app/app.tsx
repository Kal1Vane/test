  ...
  return (
    <section className="app__section flex justify-center items-center flex-col gap-40 transition-transform">
      ...
      <section className="flex justify-center items-center flex-col gap-1">
        <button className="flex pr-10 pl-10 gap-1 border border-indigo-500 py-1 rounded-md text-base hover:border-indigo-800 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 " onClick={onClickButton} disabled={isDisabled} >
